---
title: "ADR-020 — Авторитетная модель композиции профессиональных ситуаций"
type: adr
status: accepted
canon: true
depends_on: [ADR-005, ADR-007, ADR-009, ADR-010, ADR-013, ADR-014, ADR-015, ADR-016, ADR-017, ADR-018, ADR-019]
updated: 2026-07-18
---
