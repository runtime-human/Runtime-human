---
title: "ADR-018 — Авторитетная модель карьеры программиста, найма и занятости"
type: adr
status: accepted
canon: true
depends_on: [ADR-005, ADR-007, ADR-009, ADR-010, ADR-013, ADR-014, ADR-015, ADR-016, ADR-017]
updated: 2026-07-18
---
