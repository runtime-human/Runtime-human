...
- [ ] **Step 1: Add failing duplicate-span tests**
...
- [ ] **Step 3: Store arrays at extraction time and flatten at group time**
...
- [ ] **Step 1: Add failing semantic-shape tests**
...
- [ ] **Step 3: Implement exact shape validators**
...
- [ ] **Step 1: Add failing duplicate-identity and budget tests**
...
- [ ] **Step 3: Implement identity and budget classification**
...
- [ ] **Step 3: Make the CLI importable and keep executable entry behavior**
...
- [ ] **Step 4: Confirm GREEN and smoke command**
